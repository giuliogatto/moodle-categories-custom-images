...
/**
 * Strings for component 'block_custom_course_list', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['custom_course_list:addinstance'] = 'Add a new courses block';
$string['custom_course_list:myaddinstance'] = 'Add a new courses block to Dashboard';
$string['hideallcourseslink'] = 'Hide \'All courses\' link';
$string['owncourses'] = 'Admin user sees own courses';
$string['pluginname'] = 'Custom Courses';
